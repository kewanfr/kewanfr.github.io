            ...
            <div class="flex flex-col justify-center space-y-4">
              ...
              <div class="flex flex-col gap-2 min-[400px]:flex-row">
                <a
                  ...
                  href="#projets">
                  <span
                    class="absolute inset-0 bg-secondary transform -skew-x-12 scale-150 transition-transform duration-500 ease-in-out group-hover:translate-x-full"></span>
      ...
      <section
        ...
        <div class="px-4 md:px-6 mt-28">
          ...
          <div class=" gap-12 items-center max-w-[90%] ml-auto mr-auto">
            <div class="flex flex-wrap justify-center flex-row space-y-4 gap-14 ">
              <div class="flex flex-col items-center space-y-2 max-w-[25%]">
                <i
                  class="fas fa-users text-primary text-6xl"
                  aria-hidden="true"></i>
              ...
              <div class="flex flex-col items-center space-y-2 max-w-[25%]">
                <i
                  class="fas fa-rocket text-primary text-6xl"
                  aria-hidden="true"></i>
                <h3 class="text-2xl font-semibold text-foreground">
                  Autonomie
                </h3>
                <p class="text-muted backgroud text-center">
                  J'aime travailler de manière autonome et être capable de
                  mener un projet de A à Z. <br /><br />
                  J'ai réalisé de nombreux projets personnels et j'apprends souvent de nouvelles technologies par moi-même.
                </p>
              </div>
              <div class="flex flex-col items-center space-y-2 max-w-[25%]">
                <i
                  class="fas fa-comments text-primary text-6xl"
                  aria-hidden="true"></i>
                <h3 class="text-2xl font-semibold text-foreground">
                  Communication
                </h3>
                <p class="text-muted backgroud text-center">
                  Mes 3 ans de théâtre au lycée m'ont permis de développer mes compétences de communication et mon aisance à l'oral.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-col items-center space-y-6">
            ...
            <div
              ...
              <a
                ...
                title="Email">
                <i
                  class="fas fa-envelope text-primary text-[4rem] mb-2 transition"></i>
                <span class="text-base font-medium text-foreground">Email</span>
                <span class="text-sm text-muted-backgroud">contact@kewan.fr</span>
              </a>
              ...
              <a
                ...
                title="LinkedIn">
                <i
                  class="fab fa-linkedin text-primary text-[4rem] mb-2 transition"></i>
                <span class="text-base font-medium text-foreground">LinkedIn</span>
                <span class="text-sm text-muted-backgroud">Kéwan Bernier</span>
              </a>
              ...
              <a
                ...
                title="GitHub">
                <i
                  class="fab fa-github text-primary text-[4rem] mb-2 transition"></i>
                <span class="text-base font-medium text-foreground">GitHub</span>
          ...
          <div class="mt-12">
            ...
            <form
              ...
              <div class="col-span-2">
                <label for="message" class="text-muted-backgroud">Message</label>
                <textarea
                  name="message"
                  id="message"
                  class="w-full p-3 rounded-lg bg-background border border-muted-backgroud text-muted-backgroud"
